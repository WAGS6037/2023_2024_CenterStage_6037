...
@Autonomous(name="R1 Park WheelsOnly F6", group="Blue")
//@Disabled
public class R1_Park_WheelsOnly_F6 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (state == 1){
            ...
            telemetry.update();
            strafeRight(DRIVE_SPEED,0.5);
            state = 2;
        }
        if (state == 2){
            telemetry.addData("State","2");
            telemetry.update();
            encoderDrive(1,-16,-16, -16, -16, 4.0);
            state = 3;
        }
        //stopping robot
        if(state == 3){
